...
void updateGPA(double* gpaPtr, double newGpa){
    if (gpaPtr != nullptr) {
        *gpaPtr = newGpa;  // update the GPA at that memory address
    }
}
    ...
    do {
        ...
        switch (choice) {
            ...
            case 2: {
                ...
                std::cout << "Enter student index to update (0 to " <<  size - 1 << "):" << std::endl;
                std::cin >> index;
            ...
            case 4: {
                ...
                try {
                    ...
                    std::cout << "Rounded (int): " << static_cast<int>(avg) << std::endl;
                } catch (const char* msg){
                    std::cout << msg << std::endl;
                }
                break;
